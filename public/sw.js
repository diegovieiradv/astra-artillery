const CACHE_NAME = 'astra-artillery-v3';
const STATIC_ASSETS = [
  '/manifest.json',
  '/icon-192.png',
  '/icon-512.png',
  ...
  '/characters/avatar_torn.svg',
  '/characters/avatar_pyra.svg',
  '/characters/avatar_mira.svg',
  '/characters/avatar_rook.svg',
  '/characters/avatar_drax.svg',
