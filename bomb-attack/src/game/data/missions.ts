...
export const MISSIONS: MissionConfig[] = [
  ...
  },
  {
    ...
    objectives: [
      ...
      { type: 'specific_character', characterId: 'igneous', count: 5 },
      { type: 'specific_character', characterId: 'glacis', count: 5 },
      { type: 'specific_character', characterId: 'aeris', count: 5 },
    ],
  ...
  },
  {
    ...
    objectives: [
      ...
      { type: 'reach_mastery_level', characterId: 'igneous', target: 5 },
      { type: 'reach_mastery_level', characterId: 'glacis', target: 5 },
      { type: 'reach_mastery_level', characterId: 'aeris', target: 5 },
    ],
